...
export default function CreateAnEvent() {
  ...
  useEffect(() => {
    fetch(`http://bomboclat-api-1597862409.eu-west-2.elb.amazonaws.com/api/categories`)
  ...
  function handleSubmit(e){
    ...
    fetch(`http://bomboclat-api-1597862409.eu-west-2.elb.amazonaws.com/api/events/${state.id}`,{
        headers: {
